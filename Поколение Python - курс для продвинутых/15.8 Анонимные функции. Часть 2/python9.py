...
def main():
    ...
    mixed_list = ["tuesday", "abroad", "abuse", "beside", "monday", "abate",
                  ...
                  686008, "beyond", 2415643, "aboard", "bet", 859105,
                  "accident", 2223166, 894187, 146564, 1251748, 2851543,
                  1619426, 2263113, 1618068, "berth", "abolish", "beware",
                  2618492, 1555062, "access", "absent", "abundant", 2950603,
                  "betray", "beverage", "abide", "abandon", 2284251,
                  "wednesday", 2709698, "thursday", 810387, "friday", 2576799,
                  2213552, 1599022, "accept", "abuse", "abound", 1352953,
